...
val connectionString = ConnectionStringBuilder("Endpoint=sb://eventhub20220519.servicebus.windows.net/;SharedAccessKeyName=databricks;SharedAccessKey=EHdM9Gpw97liT1DeKORjmpUWvAm+7y/NPhJXzeo8Zhk=")
